...
$sql = "SELECT p.* 
        ...
        WHERE c.name = 'iphone'
        ORDER BY p.id DESC" ;
$iphones = mysqli_query($conn, $sql);

$page_title = "Sản phẩm iPhone";
...
<body>
    ...
    <div class="sanpham">
      ...
      <div class="products">
        ...
        <div class="product">
          <a href="product_detail.php?id=<?php echo $iphone['id']; ?>">
            <img src="<?php echo str_replace('../', '', $iphone['image']); ?>" width="240" height="240" />
            <h3><?php echo $iphone['name'];?></h3>
            <span><?php echo number_format($iphone['price'], 0, ',', '.');?>đ</span>
          </a>
        </div>
        <?php endforeach;?>
      </div>
